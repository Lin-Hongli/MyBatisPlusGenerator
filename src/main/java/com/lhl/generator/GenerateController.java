...
//            InputStream in = Main.class.getClassLoader().getResourceAsStream("D:\\IdeaProjects\\generatorApp\\");
            File file = new File(System.getProperty("user.dir") + "/generator.config");
            if (file.exists()){
    ...
    public void backUp(){
        try {
            FileOutputStream out = new FileOutputStream(System.getProperty("user.dir") + "/generator.config", false);//true表示追加打开
